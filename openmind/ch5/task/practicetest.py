...
def SearchWeather(UserInput):
    ...
    try:
        ...
        weather_str = "%s的天气为：白天:%s，夜间:%s" %(UserInput,WeatherDayDaily,WeatherNightDaily)
        ...
        return weather_str ,WeatherDayDaily,WeatherNightDaily,TemperatureHighDaily,TemperatureLowDaily,WindDirectionDaily,WindScaleDaily
        #print(weather_str)
